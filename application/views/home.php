...
$(function () {
  ...
  <body>
	...
	<div class="container">		
		<!-- FOOTER -->
		<section>
			<p class="text-center muted">&copy; Copyright 2022 - <br>Created By : <a href="https://thewins.web.id" target="_blank">192102125_Muhammad Reza Anggawirya</a><br>Page rendered in <strong>{elapsed_time}</strong> seconds</p>
        </section>
	</div> <!-- end container -->
